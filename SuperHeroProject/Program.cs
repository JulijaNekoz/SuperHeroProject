namespace SuperHeroProject
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Hero batMan = new Hero("Bruce", "Wayne", "Batman", 1, HeroType.Hero, 26);
            Hero elastiGirl = new Hero("Helen", "Parr", "Elastigirl", 2, HeroType.Hero, 38);
            List<Hero> metropole = new List<Hero>();
            metropole.Add(defaultHero);
            metropole.Add(batMan);
            metropole.Add(elastiGirl);
